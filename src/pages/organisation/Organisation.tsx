          ...
          <div className="flex flex-row justify-between">
            ...
            <div className="flex space-x-8">
              <div className="flex flex-col justify-center items-center gap-2">
                ...
                <p className="font-bold text-xs dark:text-dark-200">MEMBERS</p>
              </div>
              <div className="flex flex-col justify-center items-center gap-2">
                <p className="font-bold text-xl text-indigo-800 dark:text-white">
                  105
                </p>
                <p className="font-bold text-xs dark:text-dark-200">POSTS</p>
              </div>
              <div className="flex flex-col justify-center items-center gap-2">
                <p className="font-bold text-xl text-indigo-800 dark:text-white">
                  7.3k
                </p>
                <p className="font-bold text-xs dark:text-dark-200">VISITS</p>
              </div>
      ...
      <div className="pt-4">
        <div className="flex justify-center space-x-4">
          ...
          <div className="w-1/4">
            ...
            <div className="mb-4 flex flex-col space-y-7 bg-white dark:bg-dark-950 p-4 rounded-lg">
              ...
              <div className="flex flex-col space-y-3">
                <div className="w-full flex justify-between items-center">
                  ...
                  <span className="text-indigo-800 dark:text-white">
            ...
            <div className="mb-4 flex flex-col space-y-7 bg-white dark:bg-dark-950 p-4 rounded-lg">
              <h2 className="text-lg font-bold">Group Organizers</h2>
